...
int main(int argc, char** argv){
    ...
    while(programme_launched){
		...
		if(menu_principale)
		{
			...
			{
				if(slct_charger_partie) affiche_image(image, texture, pos_image, "image/slct_charger_partie.bmp", renderer, window);
				else affiche_image(image, texture, pos_image, "image/charger_partie.bmp", renderer, window);
			}
		...
		if(menu_nb_joueurs)
		{
			...
			pos_image.y = 197;
			if(slct_2) affiche_image(image, texture, pos_image, "image/slct_2.bmp", renderer, window);
			else affiche_image(image, texture, pos_image, "image/2.bmp", renderer, window);

			//affichage 3

			pos_image.y = 279;
			if(slct_3) affiche_image(image, texture, pos_image, "image/slct_3.bmp", renderer, window);
			else affiche_image(image, texture, pos_image, "image/3.bmp", renderer, window);

			//affichage 4

			pos_image.y = 361;
			if(slct_4) affiche_image(image, texture, pos_image, "image/slct_4.bmp", renderer, window);
			else affiche_image(image, texture, pos_image, "image/4.bmp", renderer, window);
		}
		...
		if(menu_charger_partie)
		{
			...
			{
				if(slct_sauvegarde1) affiche_image(image, texture, pos_image, "image/slct_sauvegarde1.bmp", renderer, window);
				else affiche_image(image, texture, pos_image, "image/sauvegarde1.bmp", renderer, window);
			}
			...
			{
				if(slct_sauvegarde2) affiche_image(image, texture, pos_image, "image/slct_sauvegarde2.bmp", renderer, window);
				else affiche_image(image, texture, pos_image, "image/sauvegarde2.bmp", renderer, window);
			}
			...
			{
				if(slct_sauvegarde3) affiche_image(image, texture, pos_image, "image/slct_sauvegarde3.bmp", renderer, window);
				else affiche_image(image, texture, pos_image, "image/sauvegarde3.bmp", renderer, window);
			}
		...
		if(menu_partie)
		{
			...
			{
				case 1 :
					affiche_image(image, texture, pos_image, "image/1.bmp", renderer, window);
					break;
				case 2 :
					affiche_image(image, texture, pos_image, "image/2.bmp", renderer, window);
					break;
				case 3 :
					affiche_image(image, texture, pos_image, "image/3.bmp", renderer, window);
					break;
				case 4 :
					affiche_image(image, texture, pos_image, "image/4.bmp", renderer, window);
					break;
				case 5 :
					affiche_image(image, texture, pos_image, "image/5.bmp", renderer, window);
					break;
				case 6 :
					affiche_image(image, texture, pos_image, "image/6.bmp", renderer, window);
					break;
				default :
					break;
			}
			...
			pos_image.y = 279;
			if((tab_j[id_joueur].p[0].d[0]==1)||(tab_j[id_joueur].p[0].d[1]==1)||(tab_j[id_joueur].p[0].d[2]==1))
			{
				if(slct_pion1) affiche_image(image, texture, pos_image, "image/slct_bouger_pion_1.bmp", renderer, window);
				else affiche_image(image, texture, pos_image, "image/bouger_pion_1.bmp", renderer, window);
			}
			...
			pos_image.y = 361;
			if((tab_j[id_joueur].p[1].d[0]==1)||(tab_j[id_joueur].p[1].d[1]==1)||(tab_j[id_joueur].p[1].d[2]==1))
			{
				if(slct_pion2) affiche_image(image, texture, pos_image, "image/slct_bouger_pion_2.bmp", renderer, window);
				else affiche_image(image, texture, pos_image, "image/bouger_pion_2.bmp", renderer, window);
			}
			...
			pos_image.y = 443;
			if((tab_j[id_joueur].p[0].d[3]==1)&&(tab_j[id_joueur].p[1].d[3]==1))
			{
				if(slct_suivant) affiche_image(image, texture, pos_image, "image/slct_suivant.bmp", renderer, window);
				else affiche_image(image, texture, pos_image, "image/suivant.bmp", renderer, window);
			}
			...
			{
				if(slct_retour) affiche_image(image, texture, pos_image, "image/slct_retour.bmp", renderer, window);
				else affiche_image(image, texture, pos_image, "image/retour.bmp", renderer, window);
			}
		...
		if(menu_demmande_sauvegarder)
		{
			...
			pos_image.y=197;
			if(slct_oui) affiche_image(image, texture, pos_image, "image/slct_oui.bmp", renderer, window);
			else affiche_image(image, texture, pos_image, "image/oui.bmp", renderer, window);

			//"non"

			pos_image.y=279;
			if(slct_non) affiche_image(image, texture, pos_image, "image/slct_non.bmp", renderer, window);
			else affiche_image(image, texture, pos_image, "image/non.bmp", renderer, window);
		}
		...
		if(menu_sauvegarder)
		{
			...
			{
				if(slct_sauvegarde1) affiche_image(image, texture, pos_image, "image/slct_sauvegarde_vide.bmp", renderer, window);
				else affiche_image(image, texture, pos_image, "image/sauvegarde_vide.bmp", renderer, window);
			}
			else
			{
				if(slct_sauvegarde1) affiche_image(image, texture, pos_image, "image/slct_sauvegarde1.bmp", renderer, window);
			...
			{
				if(slct_sauvegarde2) affiche_image(image, texture, pos_image, "image/slct_sauvegarde_vide.bmp", renderer, window);
				else affiche_image(image, texture, pos_image, "image/sauvegarde_vide.bmp", renderer, window);
			}
			else
			{
			...
			{
				if(slct_sauvegarde3) affiche_image(image, texture, pos_image, "image/slct_sauvegarde_vide.bmp", renderer, window);
				else affiche_image(image, texture, pos_image, "image/sauvegarde_vide.bmp", renderer, window);
			}
			else
			{
		...
		while(SDL_PollEvent(&event)){		//capture des evenemets 
			...
			switch(event.type){
	    		...
	    		case SDL_MOUSEBUTTONDOWN:						//clic souris
					...
					//	printf("Double Clic "); 								//double clic
