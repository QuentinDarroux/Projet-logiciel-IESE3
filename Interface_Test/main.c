...
void afficher_symbole(SDL_Renderer *renderer, SDL_Window *window, SDL_Event *event1,int posy , int posx, int Tjoue); /* fonction qui affichera une croix ou un rond au bon endroit */
...
void ordiJoue(int X, int Y, char lignegagn, char lignedef, int ** Grille); /* l'ordinateur joue */
