...
//Fonction erreur
void SDL_ExitError_c(const char *message);

//Fonction image

void affiche_image_c(SDL_Surface *image, SDL_Texture *texture, SDL_Rect pos_image, const char* file, SDL_Renderer *renderer, SDL_Window *window);
//void affiche_image_c(SDL_Surface *image, SDL_Texture *texture, SDL_Rect pos_image, const char* file, SDL_Renderer *renderer, SDL_Window *window);
...
int clic_gauche_c(int x_min, int x_max, int y_min, int y_max, SDL_Event event);

//position_c
int position_c(int x_min, int x_max, int y_min, int y_max, SDL_Event event);
...
int jeu_chevaux(SDL_Event event, SDL_Window *window, SDL_Renderer *renderer){

	//sauvegade renderer
	SDL_Renderer **sauv_renderer = &renderer;
	...
	//if(SDL_Init(SDL_INIT_EVERYTHING) != 0) SDL_ExitError_c("Initialisation echouee");

	//Creation de la fenêtre ->//position_c x,position_c y, largeur, hauteur, option fenêtre (0=DEFAUT, SDL_WINDOW_FULLSCREEN)
   //window = SDL_CreateWindow("jeu des petits chevaux", SDL_WINDOWPOS_CENTERED, SDL_WINDOWPOS_CENTERED, WINDOW_WIDTH, WINDOW_HEIGHT, 0);
	//if(window == NULL) SDL_ExitError_c("Creation de fenetre echouee");
    ...
    while(programme_launched){
		...
		//if(renderer == NULL) SDL_ExitError_c("Rendu fenetre echouee");
		...
		affiche_image_c(image, texture, pos_image, "jeu_petit_chevaux/image/base.bmp", renderer, window);
		...
		switch(menu)
		{
			case 0 : //menu principale
				...
				pos_image.y = 197;
				if(nombre_de_sauvegardes()==0) affiche_image_c(image, texture, pos_image, "jeu_petit_chevaux/image/imp_charger_partie.bmp", renderer, window);
			...
			case 1 : //menu nouvelle partie
				...
				pos_image.y = 115;
				affiche_image_c(image, texture, pos_image, "jeu_petit_chevaux/image/nb_joueurs.bmp", renderer, window);
			...
			case 2 : //menu charger partie
				...
				pos_image.y = 115;
				if(emplacement_est_vide(1)) affiche_image_c(image, texture, pos_image, "jeu_petit_chevaux/image/imp_sauvegarde_vide.bmp", renderer, window);
				else affiche_animation(slct_sauvegarde1, image, texture, pos_image, "sauvegarde1.bmp", renderer, window);

				//affichage sauvegarde 2

				pos_image.y = 197;
				if(emplacement_est_vide(2)) affiche_image_c(image, texture, pos_image, "jeu_petit_chevaux/image/imp_sauvegarde_vide.bmp", renderer, window);
				else affiche_animation(slct_sauvegarde2, image, texture, pos_image, "sauvegarde2.bmp", renderer, window);

				//affichage sauvegarde 3

				pos_image.y = 279;
				if(emplacement_est_vide(3)) affiche_image_c(image, texture, pos_image, "jeu_petit_chevaux/image/imp_sauvegarde_vide.bmp", renderer, window);
			...
			case 3 : //menu sauvegardes
				...
				pos_image.y = 115;
				if(emplacement_est_vide(1)) affiche_image_c(image, texture, pos_image, "jeu_petit_chevaux/image/imp_sauvegarde_vide.bmp", renderer, window);
				else affiche_image_c(image, texture, pos_image, "jeu_petit_chevaux/image/imp_sauvegarde1.bmp", renderer, window);

				//affichage sauvegarde 2

				pos_image.y = 197;
				if(emplacement_est_vide(2)) affiche_image_c(image, texture, pos_image, "jeu_petit_chevaux/image/imp_sauvegarde_vide.bmp", renderer, window);
				else affiche_image_c(image, texture, pos_image, "jeu_petit_chevaux/image/imp_sauvegarde2.bmp", renderer, window);

				//affichage sauvegarde 3

				pos_image.y = 279;
				if(emplacement_est_vide(3)) affiche_image_c(image, texture, pos_image, "jeu_petit_chevaux/image/imp_sauvegarde_vide.bmp", renderer, window);
				else affiche_image_c(image, texture, pos_image, "jeu_petit_chevaux/image/imp_sauvegarde3.bmp", renderer, window);
			...
			case 5 : //menu partie
				...
				pos_image.x = 720;
				pos_image.y = 115;
				if(id_joueur==0) affiche_image_c(image, texture, pos_image, "jeu_petit_chevaux/image/joueur1.bmp", renderer, window);
				if(id_joueur==1) affiche_image_c(image, texture, pos_image, "jeu_petit_chevaux/image/joueur2.bmp", renderer, window);
				if(id_joueur==2) affiche_image_c(image, texture, pos_image, "jeu_petit_chevaux/image/joueur3.bmp", renderer, window);
				if(id_joueur==3) affiche_image_c(image, texture, pos_image, "jeu_petit_chevaux/image/joueur4.bmp", renderer, window);
				...
				switch(de)
				{
					case 1 :
						...
						{
							case 0 :
								affiche_image_c(image, texture, pos_image, "jeu_petit_chevaux/image/de_1_1.bmp", renderer, window);
								break;
							case 1 :
								affiche_image_c(image, texture, pos_image, "jeu_petit_chevaux/image/de_2_1.bmp", renderer, window);
								break;
							case 2 :
								affiche_image_c(image, texture, pos_image, "jeu_petit_chevaux/image/de_3_1.bmp", renderer, window);
								break;
							case 3 :
								affiche_image_c(image, texture, pos_image, "jeu_petit_chevaux/image/de_4_1.bmp", renderer, window);
								break;
							default :
								break;
						}
					...
					case 2 :
						...
						{
							case 0 :
								affiche_image_c(image, texture, pos_image, "jeu_petit_chevaux/image/de_1_2.bmp", renderer, window);
								break;
							case 1 :
								affiche_image_c(image, texture, pos_image, "jeu_petit_chevaux/image/de_2_2.bmp", renderer, window);
								break;
							case 2 :
								affiche_image_c(image, texture, pos_image, "jeu_petit_chevaux/image/de_3_2.bmp", renderer, window);
								break;
							case 3 :
								affiche_image_c(image, texture, pos_image, "jeu_petit_chevaux/image/de_4_2.bmp", renderer, window);
								break;
							default :
								break;
						}
					...
					case 3 :
						...
						{
							case 0 :
								affiche_image_c(image, texture, pos_image, "jeu_petit_chevaux/image/de_1_3.bmp", renderer, window);
								break;
							case 1 :
								affiche_image_c(image, texture, pos_image, "jeu_petit_chevaux/image/de_2_3.bmp", renderer, window);
								break;
							case 2 :
								affiche_image_c(image, texture, pos_image, "jeu_petit_chevaux/image/de_3_3.bmp", renderer, window);
								break;
							case 3 :
								affiche_image_c(image, texture, pos_image, "jeu_petit_chevaux/image/de_4_3.bmp", renderer, window);
								break;
							default :
								break;
						}
					...
					case 4 :
						...
						{
							case 0 :
								affiche_image_c(image, texture, pos_image, "jeu_petit_chevaux/image/de_1_4.bmp", renderer, window);
								break;
							case 1 :
								affiche_image_c(image, texture, pos_image, "jeu_petit_chevaux/image/de_2_4.bmp", renderer, window);
								break;
							case 2 :
								affiche_image_c(image, texture, pos_image, "jeu_petit_chevaux/image/de_3_4.bmp", renderer, window);
								break;
							case 3 :
								affiche_image_c(image, texture, pos_image, "jeu_petit_chevaux/image/de_4_4.bmp", renderer, window);
								break;
							default :
								break;
						}
					...
					case 5 :
						...
						{
							case 0 :
								affiche_image_c(image, texture, pos_image, "jeu_petit_chevaux/image/de_1_5.bmp", renderer, window);
								break;
							case 1 :
								affiche_image_c(image, texture, pos_image, "jeu_petit_chevaux/image/de_2_5.bmp", renderer, window);
								break;
							case 2 :
								affiche_image_c(image, texture, pos_image, "jeu_petit_chevaux/image/de_3_5.bmp", renderer, window);
								break;
							case 3 :
								affiche_image_c(image, texture, pos_image, "jeu_petit_chevaux/image/de_4_5.bmp", renderer, window);
								break;
							default :
								break;
						}
					...
					case 6 :
						...
						{
							case 0 :
								affiche_image_c(image, texture, pos_image, "jeu_petit_chevaux/image/de_1_6.bmp", renderer, window);
								break;
							case 1 :
								affiche_image_c(image, texture, pos_image, "jeu_petit_chevaux/image/de_2_6.bmp", renderer, window);
								break;
							case 2 :
								affiche_image_c(image, texture, pos_image, "jeu_petit_chevaux/image/de_3_6.bmp", renderer, window);
								break;
							case 3 :
								affiche_image_c(image, texture, pos_image, "jeu_petit_chevaux/image/de_4_6.bmp", renderer, window);
								break;
							default :
								break;
						}
				...
				else affiche_image_c(image, texture, pos_image, "jeu_petit_chevaux/image/imp_bouger_pion_1.bmp", renderer, window);
				...
				else affiche_image_c(image, texture, pos_image, "jeu_petit_chevaux/image/imp_bouger_pion_2.bmp", renderer, window);
				...
				else affiche_image_c(image, texture, pos_image, "jeu_petit_chevaux/image/imp_suivant.bmp", renderer, window);

				//affichage retour

				pos_image.y = 525;
				if(!pile_est_vide(&pile_p)) affiche_animation(slct_retour, image, texture, pos_image, "retour.bmp", renderer, window);
				else affiche_image_c(image, texture, pos_image, "jeu_petit_chevaux/image/imp_retour.bmp", renderer, window);
			...
			case 6 : //menu demander sauvegarde
				...
				pos_image.y=115;
				affiche_image_c(image, texture, pos_image, "jeu_petit_chevaux/image/demmande_sauvegarde.bmp", renderer, window);
			...
			case 8 : //menu ecraser
				...
				pos_image.y = 115;
				affiche_image_c(image, texture, pos_image, "jeu_petit_chevaux/image/ecraser.bmp", renderer, window);
		...
		while(SDL_PollEvent(&event))		//capture des evenemets
		{
			switch(event.type)
			{
	    		case SDL_MOUSEBUTTONUP :		//relache clic gauche souris
					...
					switch(menu)
					{
						case 0 : //menu principale
							...
							if(clic_gauche_c(760, 1240, 115, 157,event)) //"nouvelle partie"
							{
								slct_nouvelle_partie = 0;
								menu = 1;
								break;
							}
							if(clic_gauche_c(760, 1240, 197, 239,event)&&((!emplacement_est_vide(1))||(!emplacement_est_vide(2))||(!emplacement_est_vide(3))))	//"charger partie"
							{
								slct_charger_partie = 0;
								menu = 2;
								break;
							}
							if(clic_gauche_c(760, 1240, 279, 321, event))	//"sauvegardes"
							{
								slct_sauvegardes = 0;
								menu = 3;
								break;
							}
							if(clic_gauche_c(760, 1240, 500, 542, event))	//"quitter"
							{
						...
						case 1 : //menu nouvelle partie
							...
							if(clic_gauche_c(760, 1240, 197, 239,event))	//1 joueurs
							{
								slct_2 = 0;
								menu = 5;
								nb_joueurs = 2;
							...
							if(clic_gauche_c(760, 1240, 279, 321,event))	//2 joueurs
							{
								slct_3 = 0;
								menu = 5;
								nb_joueurs = 3;
							...
							if(clic_gauche_c(760, 1240, 361, 403,event))	//3 joueurs
							{
								slct_3 = 0;
								menu = 5;
								nb_joueurs = 4;
					...
					case 2 : //menu charger partie
						...
						if((!emplacement_est_vide(1))&&(clic_gauche_c(760, 1240, 115, 157,event)))	//sauvegarde 1
							{
							...
							if((!emplacement_est_vide(2))&&(clic_gauche_c(760, 1240, 197, 239,event)))	//sauvegarde 2
							{
							...
							if((!emplacement_est_vide(3))&&(clic_gauche_c(760, 1240, 279, 321,event)))	//sauvegarde 3
							{
							...
							if(clic_gauche_c(760, 1240, 361, 403,event))	//"quitter"
							{
								slct_quitter = 0;
								menu = 0;
								break;
						...
						case 3 : //menu sauvegardes
							...
							if(clic_gauche_c(760, 1240, 361, 403,event))
							{
								init_sauvegarde();	//"reinitialiser"
								slct_reinitialiser = 1;
								break;
							}
							if(clic_gauche_c(760, 1240, 443, 485,event))	//"supprimmer"
							{
								slct_supprimer = 0;
								menu = 4;
								break;
							}
							if(clic_gauche_c(760, 1240, 525, 567,event))	//"quitter"
							{
								slct_quitter = 0;
								menu = 0;
								break;
						...
						case 4 : //menu supprimer
							...
							if(clic_gauche_c(760, 1240, 115, 157,event))
							{
								supprimer_sauvegarde(1);	//sauvegarde 1
								slct_sauvegarde1 = 1;
								break;
							}
							if(clic_gauche_c(760, 1240, 197, 239,event))
							{
								supprimer_sauvegarde(2);	//sauvegarde 2
								slct_sauvegarde2 = 1;
								break;
							}
							if(clic_gauche_c(760, 1240, 279, 321,event))
							{
						...
						case 5 : //menu partie
							...
							if((clic_gauche_c(760, 1240, 279, 321,event))&&(tab_j[id_joueur].p[0].d[0]==1))
							{
								slct_pion1 = 1;
							...
							if((clic_gauche_c(760, 1240, 279, 321,event))&&(tab_j[id_joueur].p[0].d[1]==1))
							{
								slct_pion1 = 1;
							...
							if((clic_gauche_c(760, 1240, 279, 321,event))&&(tab_j[id_joueur].p[0].d[2]==1))
							{
								slct_pion1 = 1;
							...
							if((clic_gauche_c(760, 1240, 361, 403,event))&&(tab_j[id_joueur].p[1].d[0]==1))
							{
								slct_pion2 = 1;
							...
							if((clic_gauche_c(760, 1240, 361, 403,event))&&(tab_j[id_joueur].p[1].d[1]==1))
							{
								slct_pion2 = 1;
							...
							if((clic_gauche_c(760, 1240, 361, 403,event))&&(tab_j[id_joueur].p[1].d[2]==1))
							{
								slct_pion2 = 1;
							...
							if((clic_gauche_c(760, 1240, 443, 485,event)&&(tab_j[id_joueur].p[0].d[3]==1)&&(tab_j[id_joueur].p[1].d[3]==1)))
							{
								slct_suivant = 1;
								empiler_partie(&pile_p,partie);
							...
							if((!pile_est_vide(&pile_p))&&(clic_gauche_c(760, 1240, 525, 567,event)))
							{
								slct_retour = 1;
								tab_j[id_joueur].etat=0;
							...
							if(clic_gauche_c(760, 1240, 607, 649, event)) //"quitter"
							{
								init_pile(&pile_p);
								slct_quitter = 0;
								menu = 6;
				...
				case SDL_MOUSEMOTION :	//position_c de la souris
					...
					switch(menu)
					{
						case 0 : //menu principale
							...
							slct_quitter = anim_bouton(760, 1240, 500, 542, event, slct_quitter);
							break;
	...
	SDL_DestroyRenderer(renderer);
	renderer = *sauv_renderer;
	printf("sauvegarde renderer \n");
	

	if(fermeture)	//quitte le programme
		return 2;
	else 			//quitte juste petits chevaux
		return 1;
}
...
void affiche_image_c(SDL_Surface *image, SDL_Texture *texture, SDL_Rect pos_image, const char* file, SDL_Renderer *renderer, SDL_Window *window){
	...
	if(image == NULL)
		SDL_ExitError_c("Affichage image echouee");

	texture = SDL_CreateTextureFromSurface(renderer, image);
	SDL_FreeSurface(image);
	if(texture == NULL)
		SDL_ExitError_c("Creation texture echouee");

	if(SDL_QueryTexture(texture, NULL, NULL, &pos_image.w, &pos_image.h) != 0)
		SDL_ExitError_c("Chargement texture echouee");

	if(SDL_RenderCopy(renderer, texture, NULL, &pos_image) != 0)
		SDL_ExitError_c("Affichage texture echouee");
...
void affiche_animation(int slct, SDL_Surface *image, SDL_Texture *texture, SDL_Rect pos_image, const char* file, SDL_Renderer *renderer, SDL_Window *window)
{
	...
	strcpy(normal,"jeu_petit_chevaux/image/");
	strcat(normal,file);

	strcpy(file_slct,"jeu_petit_chevaux/image/slct_");
	strcat(file_slct,file);

	strcpy(pres,"jeu_petit_chevaux/image/pres_");
	strcat(pres,file);

	switch(slct)
	{
		case 0 :
			affiche_image_c(image, texture, pos_image, normal, renderer, window);
			break;
		case 1 :
			affiche_image_c(image, texture, pos_image, file_slct, renderer, window);
			break;
		case 2 :
			affiche_image_c(image, texture, pos_image, pres, renderer, window);
			break;
		default :
			break;
	}
...
void affichage_pions(int plateau_tour[56][2], int plateau_centre[4][6][2], int plateau_ecurie[4][2], JOUEUR* tab_j, int id_joueur,SDL_Surface *image, SDL_Texture *texture, SDL_Rect pos_image, SDL_Renderer *renderer, SDL_Window *window)
{
	switch(tab_j[id_joueur].p[0].etat)
	{
		case 0 :
			...
			if(id_joueur==0) affiche_image_c(image, texture, pos_image, "jeu_petit_chevaux/image/pion_1_1_ecurie.bmp", renderer, window);
			if(id_joueur==1) affiche_image_c(image, texture, pos_image, "jeu_petit_chevaux/image/pion_2_1_ecurie.bmp", renderer, window);
			if(id_joueur==2) affiche_image_c(image, texture, pos_image, "jeu_petit_chevaux/image/pion_3_1_ecurie.bmp", renderer, window);
			if(id_joueur==3) affiche_image_c(image, texture, pos_image, "jeu_petit_chevaux/image/pion_4_1_ecurie.bmp", renderer, window);
			break;
		case 1:
			pos_image.x=plateau_tour[tab_j[id_joueur].p[0].tour-1][0];
			pos_image.y=plateau_tour[tab_j[id_joueur].p[0].tour-1][1];
			if(id_joueur==0) affiche_image_c(image, texture, pos_image, "jeu_petit_chevaux/image/pion_1_1.bmp", renderer, window);
			if(id_joueur==1) affiche_image_c(image, texture, pos_image, "jeu_petit_chevaux/image/pion_2_1.bmp", renderer, window);
			if(id_joueur==2) affiche_image_c(image, texture, pos_image, "jeu_petit_chevaux/image/pion_3_1.bmp", renderer, window);
			if(id_joueur==3) affiche_image_c(image, texture, pos_image, "jeu_petit_chevaux/image/pion_4_1.bmp", renderer, window);
			break;
	...
	switch(tab_j[id_joueur].p[1].etat)
	{
		case 0 :
			pos_image.x=plateau_ecurie[id_joueur][0];
			pos_image.y=plateau_ecurie[id_joueur][1];
			if(id_joueur==0) affiche_image_c(image, texture, pos_image, "jeu_petit_chevaux/image/pion_1_2_ecurie.bmp", renderer, window);
			if(id_joueur==1) affiche_image_c(image, texture, pos_image, "jeu_petit_chevaux/image/pion_2_2_ecurie.bmp", renderer, window);
			if(id_joueur==2) affiche_image_c(image, texture, pos_image, "jeu_petit_chevaux/image/pion_3_2_ecurie.bmp", renderer, window);
			if(id_joueur==3) affiche_image_c(image, texture, pos_image, "jeu_petit_chevaux/image/pion_4_2_ecurie.bmp", renderer, window);
			break;
		case 1:
			pos_image.x=plateau_tour[tab_j[id_joueur].p[1].tour-1][0];
			pos_image.y=plateau_tour[tab_j[id_joueur].p[1].tour-1][1];
			if(id_joueur==0) affiche_image_c(image, texture, pos_image, "jeu_petit_chevaux/image/pion_1_2.bmp", renderer, window);
			if(id_joueur==1) affiche_image_c(image, texture, pos_image, "jeu_petit_chevaux/image/pion_2_2.bmp", renderer, window);
			if(id_joueur==2) affiche_image_c(image, texture, pos_image, "jeu_petit_chevaux/image/pion_3_2.bmp", renderer, window);
			if(id_joueur==3) affiche_image_c(image, texture, pos_image, "jeu_petit_chevaux/image/pion_4_2.bmp", renderer, window);
			break;
	...
	if(tab_j[id_joueur].p[0].etat==tab_j[id_joueur].p[1].etat)
	{
		switch(tab_j[id_joueur].p[0].etat)
		{
			case 0 :
				pos_image.x=plateau_ecurie[id_joueur][0];
				pos_image.y=plateau_ecurie[id_joueur][1];
				if(id_joueur==0) affiche_image_c(image, texture, pos_image, "jeu_petit_chevaux/image/pion_1_3_ecurie.bmp", renderer, window);
				if(id_joueur==1) affiche_image_c(image, texture, pos_image, "jeu_petit_chevaux/image/pion_2_3_ecurie.bmp", renderer, window);
				if(id_joueur==2) affiche_image_c(image, texture, pos_image, "jeu_petit_chevaux/image/pion_3_3_ecurie.bmp", renderer, window);
				if(id_joueur==3) affiche_image_c(image, texture, pos_image, "jeu_petit_chevaux/image/pion_4_3_ecurie.bmp", renderer, window);
				break;
			...
			case 1 :
				if(tab_j[id_joueur].p[0].tour==tab_j[id_joueur].p[1].tour)
				{
					pos_image.x=plateau_tour[tab_j[id_joueur].p[0].tour-1][0];
					pos_image.y=plateau_tour[tab_j[id_joueur].p[0].tour-1][1];
					if(id_joueur==0) affiche_image_c(image, texture, pos_image, "jeu_petit_chevaux/image/pion_1_3.bmp", renderer, window);
					if(id_joueur==1) affiche_image_c(image, texture, pos_image, "jeu_petit_chevaux/image/pion_2_3.bmp", renderer, window);
					if(id_joueur==2) affiche_image_c(image, texture, pos_image, "jeu_petit_chevaux/image/pion_3_3.bmp", renderer, window);
					if(id_joueur==3) affiche_image_c(image, texture, pos_image, "jeu_petit_chevaux/image/pion_4_3.bmp", renderer, window);
				}
				break;
...
//position_c DANS UN ESPACE (a utiliser dans MOUSEMOTION)
...
int anim_bouton(int x_min, int x_max, int y_min, int y_max, SDL_Event event, int affiche_clear){
	...
	if(position_c(x_min, x_max, y_min, y_max, event)) return 1;
	else return 0;
...
int anim_bouton2(int x_min, int x_max, int y_min, int y_max, SDL_Event event, int affiche_clear){
	...
	if(position_c(x_min, x_max, y_min, y_max, event)) return 2;
	else return 0;
